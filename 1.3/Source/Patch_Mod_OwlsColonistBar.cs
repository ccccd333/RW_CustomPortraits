...
namespace Foxy.CustomPortraits {
	public static class Patch_Mod_OwlsColonistBar {
		private static readonly FieldInfo fieldFastColonistBar = AccessTools.Field("OwlBar.Mod_OwlBar:fastColonistBar");
		private static readonly MethodInfo methodResetCache = AccessTools.Method("OwlBar.OwlColonistBar:ResetCache");
		private static readonly MethodInfo methodResetPostfix = AccessTools.Method("OwlBar.ResetCacheTriggers:Postfix");
		...
		public static void ResetCache() {
			//methodResetCache.Invoke(fieldFastColonistBar.GetValue(null), null);
			foreach (RenderTexture tex in cache.Values) Object.Destroy(tex);
			cache.Clear();
			methodResetPostfix.Invoke(null, null);
		}

		private static RenderTexture GetPortraitTexture(Pawn pawn, Vector2 size, Rot4 rotation, Vector3 cameraOffset, float cameraZoom, bool supersample, bool compensateForUIScale, bool renderHeadgear, bool renderClothes, Dictionary<Apparel, Color> overrideApparelColors, Color? overrideHairColor, bool stylingStation) {
